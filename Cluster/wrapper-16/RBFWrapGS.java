	...
	public static void main(String[] args) throws Exception {
		...
		String[][] parameters = {
			...
			{	// 6. RBFNetwork + WrapperSubsetEval + GreedyStepwise
				"-E", "ACC", 
				"-search", "weka.core.setupgenerator.MathParameter -property classifier.classifier.ridge -min -4.0 -max 4.0 -step 2.0 -base 10.0 -expression pow(BASE,I)",
				"-search", "weka.core.setupgenerator.MathParameter -property classifier.classifier.minStdDev -min 0.3 -max 0.9 -step 0.1 -base 10.0 -expression I", 
				"-search", "weka.core.setupgenerator.ListParameter -property classifier.classifier.numClusters -list \"50 100 200 220 250\"",
				"-sample-size", "50.0", 
				"-log-file", "/projects/huanlab/wei/results16/RBFNetwork_WrapperSubsetEval_GreedyStepwise.txt", 
				"-initial-folds", "10", 
				"-subsequent-folds", "10", 
				"-num-slots", "16", 
				"-S", "1", 
