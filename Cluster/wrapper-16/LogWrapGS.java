	...
	public static void main(String[] args) throws Exception {
		...
		String[][] parameters = {
			...
			{	// 2. Logistic + WrapperSubsetEval + GreedyStepwise
				"-E", "ACC", 
				"-search", "weka.core.setupgenerator.MathParameter -property classifier.classifier.ridge -min -6.0 -max 10.0 -step 1.0 -base 10.0 -expression pow(BASE,I)",
				"-sample-size", "50.0", 
				"-log-file", "/projects/huanlab/wei/results16/Logistic_WrapperSubsetEval_GreedyStepwise.txt", 
				"-initial-folds", "10", 
				"-subsequent-folds", "10", 
				"-num-slots", "16", 
				"-S", "1", 
		...
		multisearch.setOptions(parameters[1]);
