	...
	public static void main(String[] args) throws Exception {
		...
		String[][] parameters = {
			...
			{	// 10. RBFNetwork + CfsSubsetEval + BestFirst
				"-E", "ACC", 
				"-search", "weka.core.setupgenerator.ListParameter -property classifier.classifier.maxIts -list \"-1 1 5 10 20 50\"",
				...
				"-search", "weka.core.setupgenerator.ListParameter -property classifier.classifier.numClusters -list \"5 10 20 50 100 200\"",
				"-sample-size", "100.0", 
				...
				"-E", "weka.attributeSelection.CfsSubsetEval -P 1 -E 1", 
				"-S", "weka.attributeSelection.BestFirst -D 2 -N 6",
				"-W", "weka.classifiers.functions.RBFNetwork", "-do-not-check-capabilities", "--", "-B", "200", "-S", "1", "-R", "1.0E-8", "-M", "-1", "-W", "0.1", "-do-not-check-capabilities"
			},
		...
		multisearch.setOptions(parameters[16]);
