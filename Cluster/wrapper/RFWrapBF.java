	...
	public static void main(String[] args) throws Exception {
		...
		String[][] parameters = {
			...
			{	// 3. RandomForest + WrapperSubsetEval + BestFirst
				...
				"-search", "weka.core.setupgenerator.MathParameter -property classifier.classifier.numFeatures -min 10.0 -max 35.0 -step 5.0 -base 10.0 -expression I",
				"-sample-size", "50.0", 
		...
		multisearch.setOptions(parameters[2]);
